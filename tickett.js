...
function add1() {
   d_tt+="Train Number:"+"\t"+train.no+"<br>"
   d_tt+="Train Name:"+"\t"+train.na+"<br>"
   d_tt+="From:"+"\t"+train.so+"<br>"
   d_tt+="To:"+"\t"+train.de+"<br>"
   d_tt+="Date:"+"\t"+date+"<br><br>"
}

var pd_tt="Sr.no &ensp; Name &ensp; Age &emsp; Gender &emsp; Fare";
// "Sr.no &ensp; Name &ensp; Age &emsp; Gender &emsp; Fare"
// S.no " + "\t" + " Name" + "\t" + "Age " + "\t" + "Gender " + "\t" + "Fare" + "\n";
       ...
       tab="<table align=center id='pa_t'><tr><th>Sr No</th><th>Name</th><th>Age</th><th>Gender</th><th>Fare</th></tr>";
           ...
           if (pacd>p_c) {
            ...
            //    }
               ...
               tab+="</table>"
               pd_tt+="<br>"+p_c+"\t"+p_nas+"&emsp;&emsp;"+p_ag+"&emsp;&emsp;"+p_gn+"&emsp;&emsp;&emsp;&emsp;"+p_fa;
               
            //    var pd_t+="\n"+p_c+"\t"+p_nas+"\t"+p_ag+"\t"+p_gn+"\t"+p_fa;
           console.log(p_c);
           console.log(p_na);
           console.log(p_ag);
           console.log(p_gn);
...
function get_pnr() {
    ...
    var yyyymmdd = y + m + d;
    count++;
    const pnr = ch1 + ch2 + "" + yyyymmdd + "" + count;
    return pnr;
